 ...
 * @Create Date: 2017-11-11 11:11:44
 * @Last Modified: 2017-11-11 11:11:19
 * @Description:
**/
...
static void print_config(const char* config_file) {
...
int main(int argc, char** argv) {
    ...
    if (argc < 2) {
        printf("Please pass a config file as part of the command line arguments.\n");
        return -1;
    }
